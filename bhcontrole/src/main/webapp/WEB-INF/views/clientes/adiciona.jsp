...
<div class="container">
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			<form:form action="${spring:mvcUrl('CC#salvar').build()}" method="post"
				commandName="cliente">
					...
					<div class="panel-body">
						<div class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<form:select path="endereco.estado" cssClass="form-control" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<form:select path="endereco.cidade" cssClass="form-control" />
								</div>
							</div>
							<div class="form-group">
