	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<form:form action="${spring:mvcUrl('JC#hospedagensPeriodo').build()}" 
					method="post" commandName="dateForm2" target="_blank">
				
					<spring:hasBindErrors name="dateForm2">
								...
								<spring:bind path="dataInicial">
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<form:label path="dataInicial" cssClass="col-sm-2 control-label">
											...
											<div class="col-sm-3">
												<form:input path="dataInicial" cssClass="form-control" type="date" value="${dataInicial.time}"/>	
											</div>
					...
					<div class="form-actions botoes">
						...
						title="${enviarTooltip}">
							<i class="fa fa-paper-plane-o"></i> <spring:message code="botao.enviar" />
						</button>
