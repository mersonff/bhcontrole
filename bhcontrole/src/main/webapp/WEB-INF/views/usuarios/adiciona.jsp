...
<div class="container">
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			<form:form action="${spring:mvcUrl('UC#salvar').build()}" method="post"
				commandName="usuario" data-toggle="validator" id="formUsuario">
								...
								<div class="form-group ${status.error ? 'has-error' : '' }">
									...
									<div class="col-sm-8">
										...
										<form:input path="email" cssClass="form-control"
											placeholder="${emailPlaceHolder}" type="email"/>
